    ...
    <div class="page-wrapper">
        ...
        <section class="testimonial-one" id="depoimentos">
            ...
            <div class="container">
                <div class="section-title text-center">
                    <span class="section-title__tagline"><?= $d['depoimentos']['subtitulo'] ?></span>
                    <h2 class="section-title__title"><?= $d['depoimentos']['titulo'] ?><br></h2>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-4">
                        <div class="testimonial-one__left">
                            <div class="testimonial-one__left-img">
                                <img src="<?= base_url() ?><?= $d['header']['imagem_lateral'] ?>" alt="">
                    ...
                    <div class="col-xl-8">
                        <div class="testimonial-one__right">
                            <div class="testimonial-one__right-shape-1"
                                style="background-image: url(<?= base_url() ?><?= $d['header']['imagem_lateral'] ?>);">
                            </div>
                            <div class="testimonial-one__slider">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp">
                            <div class="footer-widget__column footer-widget__about">
                                <div class="footer-widget__logo">
                                    <a href="index.html"><img src="<?= base_url() ?><?= $d['header']['logo'] ?>" alt=""></a>
                                </div>
