...
<head>
    ...
    <script data-cfasync="false" nonce="3cc09766-ef7e-4e6d-91f2-54030d8b2950">
        try {
            (function(w, d) {
                ! function(j, k, l, m) {
                    if (j.zaraz) console.error("zaraz is loaded twice");
                        ...
                        j.zaraz._v = "5874";
                        j.zaraz._n = "3cc09766-ef7e-4e6d-91f2-54030d8b2950";
                        j.zaraz.q = [];
                ...
                window.zaraz._p = async d$ => new Promise(ea => {
                    if (d$) {
                        d$.e && d$.e.forEach(eb => {
                            try {
