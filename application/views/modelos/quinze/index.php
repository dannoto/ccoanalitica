...
<html dir="ltr" lang="en-US">
  <head>
    ...
    <!--  Stylesheets==
    -->
    <link href="https://demo.zytheme.com/medisch/assets/css/vendor.min.css" rel="stylesheet"/>
  ...
  <script data-cfasync="false" nonce="3cc09766-ef7e-4e6d-91f2-54030d8b2950">try{(function(w,d){!function(j,k,l,m){if(j.zaraz)console.error("zaraz is loaded twice");else{j[l]=j[l]||{};j[l].executed=[];j.zaraz={deferred:[],listeners:[]};j.zaraz._v="5874";j.zaraz._n="3cc09766-ef7e-4e6d-91f2-54030d8b2950";j.zaraz.q=[];j.zaraz._f=function(n){return async function(){var o=Array.prototype.slice.call(arguments);j.zaraz.q.push({m:n,a:o})}};for(const p of["track","set","debug"])j.zaraz[p]=j.zaraz._f(p);j.zaraz.init=()=>{var q=k.getElementsByTagName(m)[0],r=k.createElement(m),s=k.getElementsByTagName("title")[0];s&&(j[l].t=k.getElementsByTagName("title")[0].text);j[l].x=Math.random();j[l].w=j.screen.width;j[l].h=j.screen.height;j[l].j=j.innerHeight;j[l].e=j.innerWidth;j[l].l=j.location.href;j[l].r=k.referrer;j[l].k=j.screen.colorDepth;j[l].n=k.characterSet;j[l].o=(new Date).getTimezoneOffset();if(j.dataLayer)for(const t of Object.entries(Object.entries(dataLayer).reduce((u,v)=>({...u[1],...v[1]}),{})))zaraz.set(t[0],t[1],{scope:"page"});j[l].q=[];for(;j.zaraz.q.length;){const w=j.zaraz.q.shift();j[l].q.push(w)}r.defer=!0;for(const x of[localStorage,sessionStorage])Object.keys(x||{}).filter(z=>z.startsWith("_zaraz_")).forEach(y=>{try{j[l]["z_"+y.slice(7)]=JSON.parse(x.getItem(y))}catch{j[l]["z_"+y.slice(7)]=x.getItem(y)}});r.referrerPolicy="origin";r.src="/cdn-cgi/zaraz/s.js?z="+btoa(encodeURIComponent(JSON.stringify(j[l])));q.parentNode.insertBefore(r,q)};["complete","interactive"].includes(k.readyState)?zaraz.init():j.addEventListener("DOMContentLoaded",zaraz.init)}}(w,d,"zarazData","script");window.zaraz._p=async d$=>new Promise(ea=>{if(d$){d$.e&&d$.e.forEach(eb=>{try{const ec=d.querySelector("script[nonce]"),ed=ec?.nonce||ec?.getAttribute("nonce"),ee=d.createElement("script");ed&&(ee.nonce=ed);ee.innerHTML=eb;ee.onload=()=>{d.head.removeChild(ee)};d.head.appendChild(ee)}catch(ef){console.error(`Error executing script: ${eb}\n`,ef)}});Promise.allSettled((d$.f||[]).map(eg=>fetch(eg[0],eg[1])))}ea()});zaraz._p({"e":["(function(w,d){})(window,document)"]});})(window,document)}catch(e){throw fetch("/cdn-cgi/zaraz/t"),e;};</script></head>
  <body>
    <div class="preloader">
      <div class="spinner">
        <div class="dot1"></div>
    ...
    <div class="wrapper clearfix" id="wrapperParallax">
      ...
      <header class="header header-light header-topbar" id="navbar-spy">
        ...
        <div class="top-bar">
          ...
          <div class="block-right">
            ...
            <div class="module module-language">
              <div class="selected"><img src="https://demo.zytheme.com/medisch/assets/images/module-language/en.png" alt="alt"/><span>english</span><i class="fas fa-chevron-down"></i></div>
              <div class="lang-list">
                <ul> 
                  <li> <img src="https://demo.zytheme.com/medisch/assets/images/module-language/en.png" alt="alt"/><a href="#">english</a></li>
                  <li> <img src="https://demo.zytheme.com/medisch/assets/images/module-language/ar.png" alt="alt"/><a href="#">arabic</a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <!-- End .top-bar-->
        <nav class="navbar navbar-expand-xl navbar-sticky" id="primary-menu"><a class="navbar-brand" href="index.html"><img class="logo logo-dark" src="https://demo.zytheme.com/medisch/assets/images/logo/logo-dark.svg" alt="Medisch Logo"/><img class="logo logo-mobile" src="https://demo.zytheme.com/medisch/assets/images/logo/logo-mobile.svg" alt="Medisch Logo"/></a>
        ...
        <div class="container-fluid pr-0 pl-0">
          <div class="slider-carousel owl-carousel carousel-navs" data-slide="1" data-slide-rs="1" data-autoplay="true" data-nav="true" data-dots="false" data-space="0" data-loop="true" data-speed="800" data-slider-id="#custom-carousel">
            ...
            <div class="slide bg-overlay bg-overlay-dark-slider">
              <div class="bg-section"><img src="https://demo.zytheme.com/medisch/assets/images/sliders/1.jpg" alt="Background"/></div>
              <div class="container">
                <div class="slide-content">
                  <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                      <p class="slide-desc">The health and well-being of our patients and their health care team will always be our priority, so we follow the best practices. </p>
                      <div class="slide-list">
                        <div class="icon"> <i class=" flaticon-025-examination"></i>
                          <p>exmination</p>
                        </div>
                        <div class="icon"> <i class=" flaticon-019-prescription"></i>
                          <p>prescription</p>
                        </div>
                        <div class="icon"> <i class=" flaticon-043-cardiogram"></i>
                          <p>cardiogram</p>
                        </div>
                        <div class="icon"> <i class=" flaticon-046-blood-pressure"></i>
                          <p>blood pressure</p>
                        </div>
                      </div>
                    </div>
            ...
            <!--  Start .slide-->
            <div class="slide bg-overlay bg-overlay-dark-slider">
              <div class="bg-section"><img src="https://demo.zytheme.com/medisch/assets/images/sliders/2.jpg" alt="Background"/></div>
              <div class="container">
                <div class="slide-content">
                  <div class="row">
                    <div class="col-12 col-lg-7">
                      <h1 class="slide-headline">provide aspects of medical care</h1>
                    </div>
                    <div class="col-12 col-lg-6">
                      <p class="slide-desc">The health and well-being of our patients and their health care team will always be our priority, so we follow the best practices. </p>
                      <div class="slide-list">
      ...
      <section class="features-bar" id="featuresBar-1">
        <div class="bg-section"> <img src="https://demo.zytheme.com/medisch/assets/images/background/pattern-2.jpg" alt="background"/></div>
        <div class="container"> 
          <div class="row g-0 features-holder">
            <div class="col-12 col-lg-3"> 
              <!-- Start .widget-reservation-->
              <div class="feature-panel feature-reservation">
                <div class="feature-content"><i class="flaticon-022-medical"></i>
                  <h5>emergency cases</h5>
                  <p>Please feel welcome to contact our staff with any general or medical enquiry call us</p><a href="tel:0106123214"><span class="fas fa-phone-alt"></span> 0106123214</a>
                </div>
              </div>
            </div>
            <div class="col-12 col-lg-3"> 
              <!-- Start .widget-timetable-->
              <div class="feature-panel feature-timetable">
                <div class="feature-content"><i class="flaticon-028-book"></i>
                  <h5>doctors timetable</h5>
                  <p>Qualified doctors available six days a week, view our timetable to make an appointment.</p><a class="btn btn--transparent btn-line btn-line-before" href="#"> <span class="line"> <span> </span></span><span>view timetable</span></a>
                </div>
              </div>
            </div>
            <div class="col-12 col-lg-3"> 
              <!-- Start .widget-opening-hours-->
              <div class="feature-panel feature-opening-hours">
                <div class="feature-content"><i class="flaticon-014-uniform"></i>
                  <h5>opening hours </h5>
                  <ul class="list-unstyled">
                    <li> <span>monday-friday</span><span>8:00 - 7:00 pm</span></li>
                    <li> <span>saturday</span><span>9:00 - 8:00 pm</span></li>
                    <li> <span>sunday</span><span>10:00 - 9:00 pm</span></li>
                    <li> <span>emergency</span><span>24HR / 7DAYS</span></li>
                  </ul>
                </div>
              </div>
            </div>
            <div class="col-12 col-lg-3"> 
              ...
              <div class="feature-panel feature-location">
                <div class="feature-content"><i class="flaticon-042-clinic"></i>
                  ...
                  <div class="map-img">	<a href="contact.html"></a><img src="https://demo.zytheme.com/medisch/assets/images/background/map.jpg" alt="map"/></div>
                </div>
              </div>
            </div>
          </div>
          <div class="heading heading-15">
            <div class="row"> 
              ...
              <div class="col-12 col-lg-6 offset-lg-1">
                <p class="paragraph">We provide all aspects of medical practice for your whole family, including general check-ups or assisting you with specific injuries.</p>
                <p class="heading-desc">We will work with you to develop individualised care plans, including management of chronic diseases. If we cannot assist, we can provide referrals or advice about the type of practitioner you require. We treat all enquiries sensitively and in the strictest</p>
                <div class="actions-holder"><a class="btn btn--primary btn-line btn-line-after" href="doctors-grid.html"> <span>find a doctor</span><span class="line"> <span></span></span></a><a class="btn btn--white" href="page-about.html">more about us</a></div>
              </div>
            </div>
          </div>
          <!-- End .heading-->
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-lg-8">
              <div class="about-img"><img class="img-fluid" src="https://demo.zytheme.com/medisch/assets/images/about/5.jpg" alt="about Image"/><a class="popup-video btn-video" href="https://www.youtube.com/watch?v=nrJtHemSPW4"> <i class="fas fa-play"></i><span>watch our presentation!</span></a></div>
            </div>
            <div class="col-12 col-lg-3 offset-lg-1">
              <div class="heading heading-16">
                <p class="heading-desc">We’re here to care for you and your entire family. Regular visits to the doctor will depend on your age and general health!</p>
              </div>
              <ul class="advantages-list">
                <li><i class="fas fa-check"></i> Health assessments</li>
                <li><i class="fas fa-check"></i> Home medicine review</li>
                <li><i class="fas fa-check"></i> Fractures and dislocations</li>
                <li><i class="fas fa-check"></i> Desensitisation injections</li>
              </ul>
            </div>
            <!-- End .col-lg-3-->
          </div>
          ...
          <div class="row"> 
            <div class="col-12 col-lg-6 offset-lg-3">
              <div class="heading heading-12 heading-13 text-center">
                ...
                <h2 class="heading-title">providing medical care for stickest in our community.</h2>
              </div>
            </div>
          </div>
          <div class="row"> 
            <div class=" col-12 col-md-6 col-lg-4">
              <div class="department-panel" data-hover="">
                <div class="department-panel-holder">
                  <div class="department-img"><a href="page-departments.html"></a><img src="https://demo.zytheme.com/medisch/assets/images/departments/1.jpg" alt="department img"/></div>
                  <div class="department-content"> 
                    <div class="department-title">
                      <h4><a href="page-departments.html">Neurology Clinic</a></h4>
                    </div>
                    ...
                    <ul class="department-list list-unstyled">
                      <li><i class="fas fa-check"></i> <span>neurocritical care</span></li>
                      <li><i class="fas fa-check"></i> <span>neuro oncolgy</span></li>
                      <li><i class="fas fa-check"></i> <span>geriatric neurology</span></li>
                    </ul>
                    <div class="department-more"><a class="btn btn--white btn-line btn-line-before btn-line-inversed" href="page-departments.html"> <span class="line"> <span></span></span><span>read more</span></a></div>
                  </div>
                  <!-- End .team-img-->
                  <!-- End .team-content -->
                </div>
            ...
            <div class=" col-12 col-md-6 col-lg-4">
              <div class="department-panel" data-hover="">
                <div class="department-panel-holder">
                  <div class="department-img"><a href="page-departments.html"></a><img src="https://demo.zytheme.com/medisch/assets/images/departments/2.jpg" alt="department img"/></div>
                  <div class="department-content"> 
                    <div class="department-title">
                      <h4><a href="page-departments.html">Cardiology Clinic</a></h4>
                    </div>
                    <div class="department-desc">
            ...
            <div class=" col-12 col-md-6 col-lg-4">
              <div class="department-panel" data-hover="">
                <div class="department-panel-holder">
                  <div class="department-img"><a href="page-departments.html"></a><img src="https://demo.zytheme.com/medisch/assets/images/departments/3.jpg" alt="department img"/></div>
                  <div class="department-content"> 
                    <div class="department-title">
                      <h4><a href="page-departments.html">Pathology Clinic</a></h4>
                    </div>
                    <div class="department-desc">
          ...
          <div class="departments-action"> 
            <div class="row"> 
              ...
              <div class="col-12 col-lg-5 offset-lg-2">
                <div class="doctor-action"><a class="btn btn--secondary btn-line btn-line-after" href="page-appointments.html"> <span>make appointment</span><span class="line"> <span></span></span></a>
                  <div class="doctor-info"> 
                    <div class="doctor-img"> <img src="https://demo.zytheme.com/medisch/assets/images/testimonial/5.jpg" alt="image"/></div>
                    <div class="doctor-body"> <a href="tel:0106123214">01061245741</a>
                      <p>Call 24HR / 7Days</p>
      ...
      ============================
      -->
      <section class="features features-2 bg-overlay bg-overlay-theme3 bg-parallax" id="features-2">
        <div class="bg-section"> <img src="https://demo.zytheme.com/medisch/assets/images/background/1.jpg" alt="Background"/></div>
        <div class="container">
          <div class="heading heading-14 heading-light">
            <div class="row">
              <div class="col-12 col-lg-5">
                <p class="heading-subtitle">Sets The Standard For High Quality Care Since</p>
              </div>
            </div>
            <div class="row">
              <div class="col-12 col-lg-5">
                <h2 class="heading-title">1987</h2>
              </div>
              <div class="col-12 col-lg-6 offset-lg-1">
                ...
                <div class="signature-block"><a class="btn btn--primary btn--inversed btn-line btn-line-after" href="#"><span>our core values</span><span class="line"> <span></span></span></a>
                  <div class="signature-body"> 
                    <h6>john winston</h6>
                    <p>pediatrician</p><img class="signature-img" src="https://demo.zytheme.com/medisch/assets/images/signature/2.png" alt="signature"/>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="features-card">
            <div class="card-panel reversed">
              <div class="panel-icon"><i class="flaticon-004-transplant-box"></i></div>
              <div class="panel-body"> 
                <h4>Healthcare Programs</h4>
                <p>We have put protocols to protect our patients to provide medically necessary care.</p><a class="btn btn-line btn-line-after" href="#"><span>explore programs</span><span class="line"> <span> </span></span></a>
              </div>
            </div>
            <div class="card-panel"> 
              <div class="panel-icon"> <i class="flaticon-042-clinic"></i></div>
              <div class="panel-body"> 
                <h4>Locations & Directions</h4>
                <p>Feel welcome to contact our friendly reception staff, our doctors will receive your urgent calls.</p><a class="btn btn-line btn-line-before" href="#"><span class="line"> <span> </span></span><span>get directions</span></a>
              </div>
            </div>
          </div>
          <!-- End .features-card-->
      ...
      <section class="testimonial testimonial-1 testimonial-2" id="testimonial-2">
        <div class="container">
          <div class="row">
            <div class="col-12 col-lg-5">
              <div class="clients-img"> <img src="https://demo.zytheme.com/medisch/assets/images/testimonial/image.png" alt="image"/></div>
            </div>
            <div class="col-12 col-lg-6 offset-lg-1">
              <h6 class="section-head">hear the inspiring stories of our patients</h6>
                  ...
                  <div class="testimonial-body">
                    <div class="testimonial-content">
                      ...
                      <div class="testimonial-thumb">
                        <div class="thumb-img"> <img src="https://demo.zytheme.com/medisch/assets/images/testimonial/1.jpg" alt="Testimonial Author"/><i class="icon-Quote-Icon"></i></div>
                ...
                <div class="testimonial-panel testimonial-panel-2">
                  <div class="testimonial-body">
                    <div class="testimonial-content">
                      ...
                      <p>Their doctors include highly qualified practitioners who come from a range of backgrounds &amp; bring with them a diversity of skills and special interests. They also registered nurses available to triage any urgent matters, and the administration and staff all have exceptional skills!!</p>
                      <div class="testimonial-thumb">
                        <div class="thumb-img"> <img src="https://demo.zytheme.com/medisch/assets/images/testimonial/2.jpg" alt="Testimonial Author"/><i class="icon-Quote-Icon"></i></div>
                        <div class="thumb-body"> 
                          <h6>john peter</h6>
                          <p>optima inc</p>
                        </div>
                ...
                <div class="testimonial-panel testimonial-panel-2">
                  <div class="testimonial-body">
                    <div class="testimonial-content">
                      ...
                      <p>Their doctors include highly qualified practitioners who come from a range of backgrounds &amp; bring with them a diversity of skills and special interests. They also registered nurses available to triage any urgent matters, and the administration and staff all have exceptional skills!!</p>
                      <div class="testimonial-thumb">
                        <div class="thumb-img"> <img src="https://demo.zytheme.com/medisch/assets/images/testimonial/3.jpg" alt="Testimonial Author"/><i class="icon-Quote-Icon"></i></div>
                        <div class="thumb-body"> 
                          <h6>sony blake</h6>
                          <p>koira ind</p>
                        </div>
            ...
            <div class="col-12"> 
              <div class="carousel owl-carousel carousel-navs" data-slide="3" data-slide-rs="2" data-autoplay="true" data-nav="true" data-dots="false" data-space="30" data-loop="true" data-speed="3000">
                            <div>
                              <div class="team-member" data-hover="">
                                <div class="team-member-holder">
                                  <div class="team-img"><a class="link" href="doctors-single-modern.html"></a><img src="https://demo.zytheme.com/medisch/assets/images/team/grid/1.jpg" alt="team member"/></div>
                                  <!-- End .team-img-->
                                  <div class="team-content-holder">
                                    <div class="team-content"> 
                                      <div class="team-title">
                                        <h4><a href="doctors-single-modern.html">Richard Muldoone</a></h4>
                                      </div>
                            ...
                            <div>
                              <div class="team-member" data-hover="">
                                <div class="team-member-holder">
                                  <div class="team-img"><a class="link" href="doctors-single-modern.html"></a><img src="https://demo.zytheme.com/medisch/assets/images/team/grid/2.jpg" alt="team member"/></div>
                                  <!-- End .team-img-->
                                  <div class="team-content-holder">
                                    <div class="team-content"> 
                                      <div class="team-title">
                                        <h4><a href="doctors-single-modern.html">Michael Brian</a></h4>
                                      </div>
                            ...
                            <div>
                              <div class="team-member" data-hover="">
                                <div class="team-member-holder">
                                  <div class="team-img"><a class="link" href="doctors-single-modern.html"></a><img src="https://demo.zytheme.com/medisch/assets/images/team/grid/3.jpg" alt="team member"/></div>
                                  <!-- End .team-img-->
                                  <div class="team-content-holder">
                                    <div class="team-content"> 
                                      <div class="team-title">
                                        <h4><a href="doctors-single-modern.html">Maria Andaloro</a></h4>
                                      </div>
                            ...
                            <div>
                              <div class="team-member" data-hover="">
                                <div class="team-member-holder">
                                  <div class="team-img"><a class="link" href="doctors-single-modern.html"></a><img src="https://demo.zytheme.com/medisch/assets/images/team/grid/4.jpg" alt="team member"/></div>
                                  <!-- End .team-img-->
                                  <div class="team-content-holder">
                                    <div class="team-content"> 
                                      <div class="team-title">
                                        <h4><a href="doctors-single-modern.html">Dupree Black</a></h4>
                                      </div>
                                      <div class="team-cat"><a href="#">Urologist</a></div>
                                      <div class="team-desc">
                            ...
                            <div>
                              <div class="team-member" data-hover="">
                                <div class="team-member-holder">
                                  <div class="team-img"><a class="link" href="doctors-single-modern.html"></a><img src="https://demo.zytheme.com/medisch/assets/images/team/grid/5.jpg" alt="team member"/></div>
                                  <!-- End .team-img-->
                                  <div class="team-content-holder">
                                    <div class="team-content"> 
                                      <div class="team-title">
                                        <h4><a href="doctors-single-modern.html">Markus Skar</a></h4>
                                      </div>
                                      <div class="team-cat"><a href="#">laboratory</a></div>
                                      <div class="team-desc">
                            ...
                            <div>
                              <div class="team-member" data-hover="">
                                <div class="team-member-holder">
                                  <div class="team-img"><a class="link" href="doctors-single-modern.html"></a><img src="https://demo.zytheme.com/medisch/assets/images/team/grid/6.jpg" alt="team member"/></div>
                                  <!-- End .team-img-->
                                  <div class="team-content-holder">
                                    <div class="team-content"> 
                                      <div class="team-title">
                                        <h4><a href="doctors-single-modern.html">Kiano Barker</a></h4>
                                      </div>
                                      <div class="team-cat"><a href="#">Pathologist</a></div>
                                      <div class="team-desc">
          ...
          <div class="row g-0"> 
              ...
              <div class="process-panel" data-hover="">
                ...
                <div class="process-body"> 
                  ...
                  <div class="process-content"> 
                    ...
                    <p>Medisch offers free or low-cost health coverage for adults.</p><a class="btn-line btn-line-before btn-line-inversed" href="doctors-timetable.html"><span class="line"> <span> </span></span><span>doctors timetable</span></a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="process-panel" data-hover="">
                ...
                <div class="process-body"> 
                  ...
                  <div class="process-content"> 
                    ...
                    <p>Health exams help find problems with early chances which helps.</p><a class="btn-line btn-line-before btn-line-inversed" href="javascript:void(0)"><span class="line"> <span> </span></span><span>Start A Check Up</span></a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="process-panel" data-hover="">
                ...
                <div class="process-body"> 
                  ...
                  <div class="process-content"> 
                    ...
                    <p>We have protocols to protect our patients to provide necessary care.</p><a class="btn-line btn-line-before btn-line-inversed" href="javascript:void(0)"><span class="line"> <span> </span></span><span>explore programs</span></a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-12 col-md-6 col-xl-3">
              <div class="process-panel" data-hover="">
                ...
                <div class="process-body"> 
                  <div class="process-icon"> <i class=".flaticon-021-medical-1"></i></div>
                  <div class="process-content"> 
                    <h5>Introduce To Qualified Doctors </h5>
                    <p>Our administration and support staff all have exceptional people skills</p><a class="btn-line btn-line-before btn-line-inversed" href="page-appointments.html"><span class="line"> <span> </span></span><span>meet our doctors</span></a>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section class="donations donations-3 bg-overlay bg-parallax bg-overlay-theme" id="donations-3">
        <div class="bg-section"><img src="https://demo.zytheme.com/medisch/assets/images/background/3.jpg" alt="background"/></div>
        <div class="container">
            ...
            <div class="heading heading-light heading-11">
              ...
              <div class="img-hotspot"> 
                <div class="img-hotspot-wrap">
                  <div class="img-hotspot-bg"> <img src="https://demo.zytheme.com/medisch/assets/images/background/world-map.png" alt="image"/></div>
                  <div class="img-hotspot-pointers">
                    <div class="img-hotspot-pointer" data-spot-x="15%" data-spot-y="29%"><img src="https://demo.zytheme.com/medisch/assets/images/background/map-pointer.png" alt="pointer"/>
                      <div class="info right" data-info-x="18px" data-info-y="-97px"><span>2307 Beverley Rd Brooklyn, New York 11226 U.S.</span></div>
                    </div>
                    <div class="img-hotspot-pointer" data-spot-x="48%" data-spot-y="48%"><img src="https://demo.zytheme.com/medisch/assets/images/background/map-pointer.png" alt="pointer"/>
                      <div class="info left" data-info-x="-160px" data-info-y="-97px"><span>2307 Beverley Rd Brooklyn, New York 11226 U.S.</span></div>
                    </div>
                    <div class="img-hotspot-pointer" data-spot-x="68%" data-spot-y="23%"><img src="https://demo.zytheme.com/medisch/assets/images/background/map-pointer.png" alt="pointer"/>
                      <div class="info left" data-info-x="-160px" data-info-y="-97px"><span>2307 Beverley Rd Brooklyn, New York 11226 U.S.</span></div>
                    </div>
                  </div>
                </div>
            ...
            <div>
              <div class="blog-entry" data-hover="">
                <div class="entry-img">
                  ...
                  <!-- End .entry-date--><a href="blog-single-sidebar.html"><img src="https://demo.zytheme.com/medisch/assets/images/blog/grid/1.jpg" alt="6 tips to protect your mental health when sick"/></a>
                </div>
                <!-- End .entry-img-->
            ...
            <div>
              <div class="blog-entry" data-hover="">
                <div class="entry-img">
                  ...
                  <!-- End .entry-date--><a href="blog-single-sidebar.html"><img src="https://demo.zytheme.com/medisch/assets/images/blog/grid/2.jpg" alt="Unsure About Wearing a Face Mask? How and Why"/></a>
                </div>
                <!-- End .entry-img-->
                <div class="entry-content">
                  <div class="entry-meta">
            ...
            <div>
              <div class="blog-entry" data-hover="">
                <div class="entry-img">
                  ...
                  <!-- End .entry-date--><a href="blog-single-sidebar.html"><img src="https://demo.zytheme.com/medisch/assets/images/blog/grid/3.jpg" alt="Tips for Eating Healthy When Working From Home"/></a>
                </div>
                <!-- End .entry-img-->
                <div class="entry-content">
                  <div class="entry-meta">
            ...
            <div>
              <div class="blog-entry" data-hover="">
                <div class="entry-img">
                  ...
                  <!-- End .entry-date--><a href="blog-single-sidebar.html"><img src="https://demo.zytheme.com/medisch/assets/images/blog/grid/4.jpg" alt="Why Coronavirus Cases Among Adults Is Bad News"/></a>
                </div>
                <!-- End .entry-img-->
                <div class="entry-content">
                  <div class="entry-meta">
            ...
            <div>
              <div class="blog-entry" data-hover="">
                <div class="entry-img">
                  ...
                  <!-- End .entry-date--><a href="blog-single-sidebar.html"><img src="https://demo.zytheme.com/medisch/assets/images/blog/grid/5.jpg" alt="Why Do People Get Kidney Stones in the Summer?"/></a>
                </div>
                <!-- End .entry-img-->
                <div class="entry-content">
                  <div class="entry-meta">
            ...
            <div>
              <div class="blog-entry" data-hover="">
                <div class="entry-img">
                  ...
                  <!-- End .entry-date--><a href="blog-single-sidebar.html"><img src="https://demo.zytheme.com/medisch/assets/images/blog/grid/6.jpg" alt="Do Any Drugs Really Work to Treat Coronavirus?"/></a>
                </div>
                <!-- End .entry-img-->
                <div class="entry-content">
                  <div class="entry-meta">
