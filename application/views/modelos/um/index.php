                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="hover">
                                    <div class="bg-white h-100 p-30 rounded-1">
                                        <img style="max-height:276px;" src="<?= base_url($servico['imagem']) ?>" class="w-100 mb-3 wow scaleIn" alt="">
                    ...
                    <div class="col-lg-4 col-sm-12">
                        ...
                        <div class="social-icons mb-sm-30">
                            ...
                            <a href="<?= $d['contato']['social']['linkedin'] ?>">
                                <svg width="39" height="39" id="uil--linkedin" viewBox="0 0 24 24">
                                    <path fill="#FFFFFF" d="M20.47 2H3.53a1.45 1.45 0 0 0-1.47 1.43v17.14A1.45 1.45 0 0 0 3.53 22h16.94a1.45 1.45 0 0 0 1.47-1.43V3.43A1.45 1.45 0 0 0 20.47 2M8.09 18.74h-3v-9h3ZM6.59 8.48a1.56 1.56 0 1 1 0-3.12a1.57 1.57 0 1 1 0 3.12m12.32 10.26h-3v-4.83c0-1.21-.43-2-1.52-2A1.65 1.65 0 0 0 12.85 13a2 2 0 0 0-.1.73v5h-3v-9h3V11a3 3 0 0 1 2.71-1.5c2 0 3.45 1.29 3.45 4.06Z" />
                                </svg>
                            </a>

                            <a href="<?= $d['contato']['social']['x'] ?>">
                                <svg width="38" height="38" id="fa6-brands--square-x-twitter" viewBox="0 0 448 512">
                                    <path fill="#FFFFFF" d="M64 32C28.7 32 0 60.7 0 96v320c0 35.3 28.7 64 64 64h320c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64zm297.1 84L257.3 234.6L379.4 396h-95.6L209 298.1L123.3 396H75.8l111-126.9L69.7 116h98l67.7 89.5l78.2-89.5zm-37.8 251.6L153.4 142.9h-28.3l171.8 224.7h26.3z" />
                                </svg>
                            </a>
