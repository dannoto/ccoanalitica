                        ...
                        <div class="header-inner">
                            <div class="de-flex sm-pt10">
                                <div class="de-flex-col">
                                    <div id="logo">
                                        <a href="#top">
                                            <img class="logo-main" src="images/logo-black.webp"
                                                alt="Clínica Sorriso Perfeito">
                                            <img class="logo-scroll" src="images/logo-black.webp"
                                                alt="Clínica Sorriso Perfeito">
                                            <img class="logo-mobile" src="images/logo-black.webp"
                                                alt="Clínica Sorriso Perfeito">
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-4">
                                        <div class="col-lg-12">
                                            <div class="rounded-1 overflow-hidden wow zoomIn">
                                                <img src="images/misc/p1.webp" class="w-100 wow scaleIn"
                                                    alt="Clínica Sorriso Perfeito">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="rounded-1 overflow-hidden wow zoomIn" data-wow-delay=".3s">
                                                <img src="images/misc/p2.webp" class="w-100 wow scaleIn"
                                                    alt="Paciente feliz">
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="container">
                <div class="row gx-5">
                    <div class="col-lg-4 col-sm-6">
                        <img src="images/logo-white.webp" class="logo-footer" alt="Clínica Sorriso Perfeito">
