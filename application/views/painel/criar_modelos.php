...
<body>
    ...
    <header>
        ...
        <div style="display:flex;justify-content:space-between;width:70%;margin-left:15%">
            <div>
                <h1><small></small> <br>Criar Modelo </h1>
                <br>
                <p></p>
            </div>
            <div>
    ...
    <section class="modelos">
        ...
        <div style="margin: 0 auto; width: 100%; max-width: 600px;">
            <form id="update_model" action="">
                ...
                <input id="model_title" required name="model_title" value="" type="text" required>

                <label for="model_image">IMAGEM</label>
                <input id="model_image" required name="model_image" value="" type="text">

                <label for="model_link">LINK DO MODELO</label>
                <input id="model_link" required name="model_link" value="" type="text">

                <label for="model_description">DESCRIÇÃO</label>
                <input id="model_description" name="model_description" value="" type="text">

                <label for="model_language">LINGUAGEM / CMS</label>
                <input id="model_language" required name="model_language" value="" type="text">
                ...
                <button type="submit" class="btn btn--outline">CRIAR</button>
            </form>
        </div>
    ...
    <script>
        $('#update_model').on('submit', function(e) {
            ...
            $.ajax({
                url: '<?= base_url() ?>painel/act_add_model',
                type: 'POST',
                data: dados,
                // dataType: 'json',
                success: function(res) {
                    ...
                    Swal.fire({
                        ...
                        window.location.href = "<?= base_url() ?>painel/modelos/editar/" + res;
                    });
